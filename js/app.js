  ...
  <div class="wrap section" style="max-width:440px;">
    <div class="card card-pad">
      ...
      <form data-action="login-form">
        ...
        <button class="btn btn-brass btn-block" type="submit">Log in</button>
      </form>
...
route('/register', () => `
  <div class="wrap section" style="max-width:520px;">
    <div class="card card-pad">
      <div class="eyebrow">JOIN TUITIONMITRA</div>
      <h2>Create your account</h2>
      <div id="authError"></div>
      <form data-action="register-form">
        <div class="field"><label>I am a…</label>
          <div class="chip-select">
            ${['student','teacher','parent'].map((r,i)=>`<label><input type="radio" name="role" value="${r}" ${i===0?'checked':''}> ${r[0].toUpperCase()+r.slice(1)}</label>`).join('')}
          </div>
        </div>
        <div class="field-row">
        ...
        <div class="field-row">
          ...
          <div class="field"><label>Mobile number</label><input name="phone" required placeholder="10-digit number"></div>
        </div>
        <div class="field"><label>Password</label><input name="password" type="password" required minlength="6"></div>
        <button class="btn btn-brass btn-block" type="submit">Create account</button>
      </form>
